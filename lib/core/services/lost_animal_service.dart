...
class LostAnimalService {
  ...
  Future createLostAnimal(
      LostAnimal animal, List<File> photos, String userType) async {
    try {
      await _firestore
          .collection(userType)
      ...
      await uploadPhotosAndGetLinks(animal.lostAnimalID!, photos, userType);
    } catch (e) {
      print(e.toString());
    }
  }
  ...
  Future deleteLostAnimal(String lostAnimalID, String userType) async {
    try {
      await _firestore
          .collection(userType)
          .doc(_auth.currentUser?.uid)
      ...
      await deletePhotos(lostAnimalID, userType);
    } catch (e) {
      print(e.toString());
    }
  }
  ...
  Future<LostAnimal?> getLostAnimal(
      String lostAnimalID, String userType) async {
    try {
  ...
  Future<List<LostAnimal>> getUserLostAnimals(String userType) async {
    try {
  ...
  Future uploadPhotosAndGetLinks(
      String lostAnimalID, List<File> photos, String userType) async {
    try {
  ...
  */
  ...
  Future deletePhotos(String lostAnimalID, String userType) async {
    try {
      Reference ref = _storage
          .ref()
          .child(userType)
