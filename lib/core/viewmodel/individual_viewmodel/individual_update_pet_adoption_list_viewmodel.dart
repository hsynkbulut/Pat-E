...
class IndividualUpdatePetAdoptionListViewModel with ChangeNotifier {
    ...
    try {
      ...
      AnimalAdoption? currentPetAdoptionListing =
          await _petAdoptionListingService.getAnimalAdoption(
              petAdoptionListing.animalID!, TTexts.individualUsers);
      ...
      await _petAdoptionListingService.updateAnimalAdoption(
          updateHouseListing, selectedImages, TTexts.individualUsers);
      ...
      Navigator.push(
        ...
        MaterialPageRoute(
            builder: (context) =>
                const IndividualUpdatePetAdoptionListingScreen()),
      );
    } catch (e) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
