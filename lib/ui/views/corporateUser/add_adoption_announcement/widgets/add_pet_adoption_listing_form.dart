...
import 'package:pat_e/core/viewmodel/corporate_viewmodel/corporate_add_pet_adoption_list_viewmodel.dart';
import 'package:pat_e/ui/views/corporateUser/add_adoption_announcement/widgets/corporate_pick_adoption_images_screen.dart';
import 'package:pat_e/ui/widgets/individual_widgets/individual_text_form_field.dart';

class AddPetAdoptionListingForm extends StatefulWidget {
  const AddPetAdoptionListingForm({
    super.key,
  });

  @override
  State<AddPetAdoptionListingForm> createState() =>
      _AddPetAdoptionListingFormState();
}

class _AddPetAdoptionListingFormState extends State<AddPetAdoptionListingForm> {
  //final viewModel = AddHouseListViewModel();
  final CorporateAddPetAdoptionListViewModel viewModel =
      CorporateAddPetAdoptionListViewModel();
        ...
        Column(
          ...
          children: [
            ...
            SizedBox(
              ...
              width: width * 0.9,
              child: CorporatePickAdoptionImagesScreen(viewModel: viewModel),
            ),
          ],
        ),
        const SizedBox(height: TSizes.spaceBtwInputFields),
