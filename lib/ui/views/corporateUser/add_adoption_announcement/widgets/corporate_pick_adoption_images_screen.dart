...
class CorporatePickAdoptionImagesScreen extends StatefulWidget {
  final CorporateAddPetAdoptionListViewModel viewModel;

  const CorporatePickAdoptionImagesScreen({
    super.key,
    required this.viewModel,
  });

  @override
  State<CorporatePickAdoptionImagesScreen> createState() =>
      _CorporatePickAdoptionImagesScreenState();
}

class _CorporatePickAdoptionImagesScreenState
    extends State<CorporatePickAdoptionImagesScreen> {
