...
class GetPetAdoptionListingScreen extends StatefulWidget {
  const GetPetAdoptionListingScreen({super.key});

  @override
  _GetPetAdoptionListingScreenState createState() =>
      _GetPetAdoptionListingScreenState();
}

class _GetPetAdoptionListingScreenState
    extends State<GetPetAdoptionListingScreen> {
