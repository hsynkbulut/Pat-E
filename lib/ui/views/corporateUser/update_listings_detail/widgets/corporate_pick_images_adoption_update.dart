...
class CorporatePickImagesAdoptionUpdateScreen extends StatefulWidget {
  final CorporateUpdatePetAdoptionListViewModel viewModel;

  const CorporatePickImagesAdoptionUpdateScreen({
    super.key,
    required this.viewModel,
  });

  @override
  State<CorporatePickImagesAdoptionUpdateScreen> createState() =>
      _CorporatePickImagesAdoptionUpdateScreenState();
}

class _CorporatePickImagesAdoptionUpdateScreenState
    extends State<CorporatePickImagesAdoptionUpdateScreen> {
