...
class IndividualPickImagesAdoptionScreen extends StatefulWidget {
  final IndividualAddPetAdoptionListViewModel viewModel;

  const IndividualPickImagesAdoptionScreen({
    super.key,
    required this.viewModel,
  });

  @override
  State<IndividualPickImagesAdoptionScreen> createState() =>
      _IndividualPickImagesAdoptionScreenState();
}

class _IndividualPickImagesAdoptionScreenState
    extends State<IndividualPickImagesAdoptionScreen> {
                              ...
                              children: [
                                ClipRRect(
                                  ...
                                  child: Image.file(
                                    ...
                                    height: 105,
                                    filterQuality:
                                        FilterQuality.high, //FilterQuality.low
