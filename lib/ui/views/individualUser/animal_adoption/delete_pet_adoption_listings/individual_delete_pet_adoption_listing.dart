...
class IndividualDeletePetAdoptionListingScreen extends StatefulWidget {
  const IndividualDeletePetAdoptionListingScreen({super.key});

  @override
  _IndividualDeletePetAdoptionListingScreenState createState() =>
      _IndividualDeletePetAdoptionListingScreenState();
}

class _IndividualDeletePetAdoptionListingScreenState
    extends State<IndividualDeletePetAdoptionListingScreen> {
  ...
  Future<void> deletePetAdoptionListing(int index) async {
    try {
      ...
      await _petAdoptionListingService.deleteAnimalAdoption(
          deletedPetAdoptionListing.animalID!, TTexts.individualUsers);
