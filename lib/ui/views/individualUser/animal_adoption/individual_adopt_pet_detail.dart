...
class IndividualAdoptPetPageDetail extends StatefulWidget {
  final AnimalAdoption animalAdoption;

  const IndividualAdoptPetPageDetail({super.key, required this.animalAdoption});

  @override
  State<IndividualAdoptPetPageDetail> createState() =>
      _IndividualAdoptPetPageDetailState();
}

class _IndividualAdoptPetPageDetailState
    extends State<IndividualAdoptPetPageDetail> {
  @override
            ...
            children: [
              Padding(
                ...
                child: ExploreCarouselSlider(
                  images: widget.animalAdoption.photos!,
                ),
              ),
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                widget.animalAdoption.district,
                                style: TextStyle(
                                  color:
                                      AppColors.primaryColor.withOpacity(0.8),
                                ),
