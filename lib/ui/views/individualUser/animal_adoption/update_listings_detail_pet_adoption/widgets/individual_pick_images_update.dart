...
class IndividualPickImagesUpdateScreen extends StatefulWidget {
  final IndividualUpdatePetAdoptionListViewModel viewModel;

  const IndividualPickImagesUpdateScreen({
    super.key,
    required this.viewModel,
  });

  @override
  State<IndividualPickImagesUpdateScreen> createState() =>
      _IndividualPickImagesUpdateScreenState();
}

class _IndividualPickImagesUpdateScreenState
    extends State<IndividualPickImagesUpdateScreen> {
