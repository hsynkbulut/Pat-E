...
import 'package:pat_e/ui/views/individualUser/animal_adoption/update_listings_detail_pet_adoption/widgets/individual_pick_images_update.dart';
import 'package:pat_e/ui/widgets/individual_widgets/individual_text_form_field.dart';

class IndividualUpdatePetAdoptionListingForm extends StatefulWidget {
  final AnimalAdoption houseListing;
  final IndividualUpdatePetAdoptionListViewModel viewModel;

  const IndividualUpdatePetAdoptionListingForm({
    super.key,
  ...
  @override
  State<IndividualUpdatePetAdoptionListingForm> createState() =>
      _IndividualUpdatePetAdoptionListingFormState();
}

class _IndividualUpdatePetAdoptionListingFormState
    extends State<IndividualUpdatePetAdoptionListingForm> {
  @override
  void initState() {
    super.initState();
        ...
        Column(
          ...
          children: [
            ...
            SizedBox(
              ...
              width: width * 0.9,
              child:
                  IndividualPickImagesUpdateScreen(viewModel: widget.viewModel),
            ),
          ],
        ),
        const SizedBox(height: TSizes.spaceBtwInputFields),
