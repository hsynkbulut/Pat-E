...
import 'package:pat_e/ui/views/individualUser/animal_adoption/update_listings_detail_pet_adoption/individual_update_pet_adoption_listing_detail.dart';
import 'package:pat_e/ui/widgets/custom_appbar.dart';

class IndividualUpdatePetAdoptionListingScreen extends StatefulWidget {
  const IndividualUpdatePetAdoptionListingScreen({super.key});

  @override
  _IndividualUpdatePetAdoptionListingScreenState createState() =>
      _IndividualUpdatePetAdoptionListingScreenState();
}

class _IndividualUpdatePetAdoptionListingScreenState
    extends State<IndividualUpdatePetAdoptionListingScreen> {
  List<AnimalAdoption> _petAdoptionListings = [];
  final AnimalAdoptionService _houseListingService = AnimalAdoptionService();
  IndividualUpdatePetAdoptionListViewModel viewModel =
      IndividualUpdatePetAdoptionListViewModel();
                        ...
                        SlidableAction(
                            ...
                            onPressed: (context) => {
                                  Navigator.push(
                                    ...
                                    MaterialPageRoute(
                                        builder: (context) =>
                                            IndividualUpdatePetAdoptionListingDetailScreen(
                                              petAdoptionListing:
