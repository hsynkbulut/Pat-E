...
class IndividualPickImagesLostScreen extends StatefulWidget {
  final IndividualAddLostListViewModel viewModel;

  const IndividualPickImagesLostScreen({
    super.key,
    required this.viewModel,
  });

  @override
  State<IndividualPickImagesLostScreen> createState() =>
      _IndividualPickImagesLostScreenState();
}

class _IndividualPickImagesLostScreenState
    extends State<IndividualPickImagesLostScreen> {
