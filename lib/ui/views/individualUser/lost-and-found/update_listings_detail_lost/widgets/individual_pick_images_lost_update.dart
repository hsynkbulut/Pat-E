...
class IndividualPickImagesLostUpdateScreen extends StatefulWidget {
  final IndividualUpdateLostListViewModel viewModel;

  const IndividualPickImagesLostUpdateScreen({
    super.key,
    required this.viewModel,
  });

  @override
  State<IndividualPickImagesLostUpdateScreen> createState() =>
      _IndividualPickImagesLostUpdateScreenState();
}

class _IndividualPickImagesLostUpdateScreenState
    extends State<IndividualPickImagesLostUpdateScreen> {
