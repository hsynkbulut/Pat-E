...
import 'package:pat_e/ui/views/individualUser/edit_profile/individual_edit_profile_page.dart';
                  ...
                  child: ElevatedButton(
                    onPressed: () async {
                      final updatedUser = await Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => IndividualEditProfilePage(
                              individual: viewModel.individual),
                        ),
                      );
