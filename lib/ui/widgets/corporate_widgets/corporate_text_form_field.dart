...
class CorporateTextFormField extends StatefulWidget {
  ...
  @override
  State<CorporateTextFormField> createState() => _CorporateTextFormFieldState();
}

class _CorporateTextFormFieldState extends State<CorporateTextFormField> {
